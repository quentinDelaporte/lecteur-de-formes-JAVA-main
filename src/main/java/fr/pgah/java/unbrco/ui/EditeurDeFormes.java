...
public class EditeurDeFormes extends JFrame {
  ...
  public static final int LONGUEUR = 1500;
  ...
  private void creerOutils() {
    ...
    OutilFormeCarre outilFormeCarre = new OutilFormeCarre(this, zoneOutils, "Instrument 1", 1, 1);
    outils.add(outilFormeCarre);

    OutilFormeOvale OutilFormeOvale = new OutilFormeOvale(this, zoneOutils, "Instrument 2", 2, 2);
